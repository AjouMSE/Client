...
namespace UI.Game.CardSelection
{
    public class HUDGameSelectedCardUIController : MonoBehaviour
    {
        ...
        private void Init()
        {
            ...
            MagicaDuelGameManager.Instance.SelectedCardUIController = this;
        ...
        {
           var invalidCards = MagicaDuelGameManager.Instance.GetInvalidCards();
        ...
        {
            if (MagicaDuelGameManager.Instance.CanCardSelect)
                MagicaDuelGameManager.Instance.StopTimer();
        }

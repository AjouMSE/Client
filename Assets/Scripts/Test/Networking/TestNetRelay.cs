...
{
    public class TestNetRelay : MonoSingleton<TestNetRelay>
    {
        ...
        private async void StartService(ServiceType type, string joinCode = default)
        {
        ...
        {
            StartService(ServiceType.Host);
        }

        public void StartClient(string joinCode)
        {
            StartService(ServiceType.Client, joinCode);
        }
